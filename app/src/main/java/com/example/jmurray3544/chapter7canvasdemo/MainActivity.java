package com.example.jmurray3544.chapter7canvasdemo;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get areference ot our ImageView in the layout
        ImageView ourFrame = (ImageView) findViewById(R.id.imageView);

        //Create a bitmap object to use as our canvas
        Bitmap ourBitmap = Bitmap.createBitmap(600,750, Bitmap.Config.ARGB_8888);
        ...
        ourCanvas.drawColor(Color.DKGRAY);
        ...
        ourCanvas.drawLine(10, 50, 375, 50, paint);
